    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>{{ $c->name }}</td>
            <td>
            <a href="/dashboard/categories/{{ $c->slug }}" class="badge bg-info"><span data-feather="eye" class="align-text-bottom"></span></a>
            <a href="/dashboard/categories/{{ $c->slug }}/edit" class="badge bg-warning"><span data-feather="edit" class="align-text-bottom"></span></a>
